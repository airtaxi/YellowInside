...
[![Microsoft Store에서 다운로드](https://get.microsoft.com/images/en-US%20dark.svg)](https://apps.microsoft.com/detail/9PG8PCFFZ7BD)

## 주요 기능

- 메신저 채팅창에 디시콘 버튼 자동 부착
- 디시콘 이미지 검색 및 전송
- 아카콘(아카라이브 이모티콘) 검색·다운로드·전송 지원
- 인벤 스티커 검색·다운로드·전송 지원
- 시작 프로그램 등록 지원
...
이 앱은 (주)카카오와 어떠한 제휴나 연관 관계도 없습니다. 메신저의 내부 코드를 수정하거나 역공학하지 않으며, Windows API를 통한 UI 후킹만으로 동작합니다. 이는 일반적인 Windows 자동화 기법의 범위에 해당합니다.

이 도구의 사용이 메신저 서비스 이용약관에 부합하는지는 사용자가 직접 확인해야 하며, 비공식 자동화 도구 사용은 서비스 약관 위반으로 간주되어 계정 제재 등의 조치를 받을 수 있습니다. 사용으로 발생하는 모든 결과에 대한 책임은 전적으로 사용자에게 있습니다.
